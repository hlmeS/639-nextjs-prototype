...
import { PaperClipIcon, ThumbDownIcon } from '@heroicons/react/solid'
...
export default function TodoConponent ({
	todo
} : {
	todo: Todo 
}) {
      ...
      <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
        <dl className="sm:divide-y sm:divide-gray-200">
          ...
          <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{ todo.description }</dd>
          </div>
          <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
