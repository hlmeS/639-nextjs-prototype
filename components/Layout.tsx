  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-100">
			<Head>
				...
				<meta
					name="description"
					content="Paper Submission, Review, and Registration for the Hawaii International Conference on System Sciences"
				/>
				<meta charSet="utf-8" />
      ...
      <div className="hidden bg-blue-900 md:flex md:flex-shrink-0">
              ...
              <nav className="mt-5 flex-1 px-2 space-y-1">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-blue-600 text-white' : 'text-white hover:bg-blue-700 hover:bg-opacity-75',
